...
//printDialog1.Document = printDocument1;  
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            string nomem = "";
            string nomeComposM = "";
            string nm_nome_social = paciente.nm_social;
            string nm_nome = paciente.nm_paciente;
            string nm_nome_mae = paciente.nm_mae_paciente;
            string nm_nome_pai = paciente.nm_pai_paciente;
            if (!nm_nome_social.Equals(""))
            {
                nm_nome = nm_nome_social + " (" + nm_nome + ")";
            }

            if (nm_nome.Length > 40)
            {
             nomep = nm_nome.Substring(0, 40);
             nomeCompos = nm_nome.Substring(40);
            }
            if (nm_nome_mae.Equals("DESCONHECIDA"))
            {
                nm_nome_mae = nm_nome_pai;
            }
            if (nm_nome_mae.Length > 40)
            {
                nomem = nm_nome_mae.Substring(0, 40);
                nomeComposM = nm_nome_mae.Substring(40);
            }
           ...
           // printDialog1.PrinterSettings.DefaultPageSettings.PaperSize = new System.Drawing.Printing.PaperSize("Custom2", 500, 1000);
            Graphics g = e.Graphics;
                    ...
                    if (nm_nome.Length > 40)
                    {
                        ...
                        g.DrawString("Data: " + paciente.check_in, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty +15);
                       ...
                       if (paciente.nm_mae_paciente.Length > 40)
                       {
                           ...
                           g.DrawString("Filiação: " + nm_nome_mae, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 75);
                    ...
                    else
                    {
                        ...
                        g.DrawString("Data: " + paciente.check_in, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 15);
                        g.DrawString("Nome: " + nm_nome, new Font("Arial", 8, FontStyle.Bold), System.Drawing.Brushes.Black, startXEsquerda, starty + 30);
                        ...
                        else
                        {
                            ...
                            g.DrawString("Filiação: " + nm_nome_mae, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 60);
